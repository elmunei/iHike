    ...
    if (recent[kTYPE] as? String)! == kPRIVATE {
        ...
        for userId in recent[kMEMBERS] as! [String] {
            ...
            if userId != FUser.currentUser()!.objectId {
                ...
                createRecent(userId: userId, chatRoomId: (recent[kCHATROOMID] as? String)!, members: recent[kMEMBERS] as! [String], withUserUserId: FUser.currentUser()!.objectId, withUserUsername: FUser.currentUser()!.username, type: kPRIVATE)
            }
